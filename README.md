...
3.  **Помощник в Home Assistant**
    ...
    Расписание является собой строкой значений, разделенных точкой с запятой, где каждое значение время включения и выключения в 24-часовом формате, разделенные дефисом, например: `05:30-07:00;09:00-10:00;11:00-12:00;20:00-22:00`
